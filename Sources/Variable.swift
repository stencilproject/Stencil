...
public struct Variable : Equatable, Resolvable {
  ...
  public func resolve(_ context: Context) throws -> Any? {
    ...
    if (variable.hasPrefix("'") && variable.hasSuffix("'")) || (variable.hasPrefix("\"") && variable.hasSuffix("\"")) {
      ...
      #else
        let startIndex = variable.characters.index(after: variable.startIndex)
        let endIndex = variable.characters.index(before: variable.endIndex)
      #endif

      return String(variable[startIndex ..< endIndex])
    }
